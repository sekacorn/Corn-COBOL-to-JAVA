/*
 * SubtractStatement - SUBTRACT statement
 * Author: Sekacorn
 * Created: 2025-01-10
...
// SUBTRACT Statement
public record SubtractStatement(
        @JsonProperty("operands") List<Expression> operands,
        @JsonProperty("from") List<Expression> from,
    ...
    public SubtractStatement {
        ...
        from = from != null ? List.copyOf(from) : Collections.emptyList();
